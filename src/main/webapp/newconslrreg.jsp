...
<ul>
  <li><a href="counsellorlogin">Home</a></li>
...
<h3 align=center><u>Counsellor Registration</u></h3>
...
<form:form action="newcnslrreg1" method="post" modelAttribute="mentor">
...
<form:option value="Counsellor">Counsellor</form:option>
